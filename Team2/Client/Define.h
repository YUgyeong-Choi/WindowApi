...
enum OBJID { OBJ_NONE = 0, OBJ_PLAYER, OBJ_MONSTER, OBJ_ITEM, OBJ_LINE, OBJ_RECT,OBJ_END };
enum TAG { TAG_NONE, TAG_LINE, TAG_WALL, TAG_FLOOR, TAG_END };
enum LINE { LINE_NONE, LINE_WALL, LINE_FLOOR, LINE_END };
enum PLAYERSTATUS { PS_NORMAL, PS_MUSHROOM, PS_FIRE, PS_STAR, PS_END };
enum ACTIONSTATUS { AS_STOP, AS_MOVE_LEFT, AS_MOVE_RIGHT, AS_FALL, AS_JUMP, AS_END };
enum RECTANGLETYPE {RECT_NONE, RECT_ITEM, RECT_RANDOM, RECT_END};
